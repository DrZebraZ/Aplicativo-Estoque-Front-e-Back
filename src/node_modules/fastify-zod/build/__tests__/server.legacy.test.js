...
var _serverLegacy = require("./server.legacy.fixtures");
test(`server.legacy`, async () => {
  const f = (0, _serverLegacy.createLegacyTestServer)({}, {}, {});
  await expect(f.inject({
    method: `get`,
    url: `/item`
...
//# sourceMappingURL=server.legacy.test.js.map